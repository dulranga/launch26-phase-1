...
export default function MetricsPanel() {
  ...
  return (
    <div className="bg-neutral-900/50 backdrop-blur-md p-6 rounded-xl border border-white/5 flex flex-col gap-6 h-full max-h-[500px] overflow-y-auto custom-scrollbar">
      <div>
        ...
        <div className="flex items-center gap-2 text-xs font-mono tracking-wider overflow-x-auto pb-2 whitespace-nowrap">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-xs text-cyan-500/70 font-bold uppercase tracking-widest">Hop Latency Breakdown</h3>
        {activeRoute.hops.map((hop, i) => (
          <div key={i} className="bg-neutral-950 border border-white/5 rounded p-3 text-xs font-mono">
